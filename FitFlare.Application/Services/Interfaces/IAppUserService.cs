...
public interface IAppUserService
{
    ...
    public Task<ViewUserDto> GetSingleUser(string id);
    public Task<IEnumerable<AppUserDto>> GetAll(int page, string? sort, int pageSize = 5, bool tracking = true,
        string? searchText = null);
    public Task<IEnumerable<AppUserDto>> GetAllUnBanned(int page, string? sort, int pageSize = 5, bool tracking = true,
        string? searchText = null);
