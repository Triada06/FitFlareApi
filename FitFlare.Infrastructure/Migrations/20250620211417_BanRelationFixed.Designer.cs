...
namespace FitFlare.Infrastructure.Migrations
{
    ...
    [Migration("20250620211417_BanRelationFixed")]
    partial class BanRelationFixed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitFlare.Core.Entities.Ban", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FitFlare.Core.Entities.Message", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FitFlare.Core.Entities.Ban", b =>
                {
                    b.HasOne("FitFlare.Core.Entities.AppUser", "AppUser")
                        .WithMany("Bans")
